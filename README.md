# CKLabel [![Carthage compatible](https://img.shields.io/badge/Carthage-compatible-4BC51D.svg?style=flat)](https://github.com/Carthage/Carthage)

A TextKit Label build upon [facebook/componentkit](https://github.com/facebook/componentkit)

- asynchronous drawing
- support custom truncationAttributedString
- support AutoLayout

## Using carthage

```
github "cntrump/CKLabel" "master"
```

![](https://github.com/cntrump/CKLabel/raw/master/ScreenShot/ScreenShot1.png)
